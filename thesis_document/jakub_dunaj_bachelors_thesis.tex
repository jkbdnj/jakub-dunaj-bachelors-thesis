...
\section{Discussion}
    ...
    \autoref{fig:initial-train-accuracy-per-class} shows accuracies of each class averaged over all 8 epochs during the training phase of the initial cycle. The model reached 83\% average accuracy over all classes. The model reported accuracy of at least 80\% in 71\% of the classes. In 34\% of the classes, the model reached accuracy of at least 90\%. The model really struggled in prediction the diseased tomato leaves. After revision of the tomato disease classes, the images in these classes are very similar. There were probably not enough images for the model to learn to distinguish between the different tomato leaf diseases.
    ...
    \autoref{fig:initial-test-accuracy-per-class} shows accuracies of each class averages over all 8 epochs during the testing phase of the initial cycle. The model reported very similar results to those achieved during the training. Same as in the training phase, the model reported lower accuracies in the case of tomato disease classes.
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
        ...
        Having more images and applying less conservative training strategy would lead to higher accuracies.
