...
\section{Design}
    ...
    \subsection{CNN Architecture} % EfficientNetB0 (from pertained models in Keras)
    ...
    % transfer learning with and whithout the fine-tuning step
    % modificiaion of the CNN architecutre prior the training process
    % parameters used for the training: so the adam, loss function, batch size and number of epochs
